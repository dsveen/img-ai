        ...
        <div className="xl:py-24 py-16">
            <div className="container">
                ...
                <div className="text-center">
                    ...
                    <p className="text-gray-500">Start working with <span className="text-primary">Prompt</span> to manage your workforce better</p>
                </div>
                    ...
                    <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 items-center">
                        ...
                        <div className="lg:ms-24">
                            <div data-fc-type="accordion" data-aos="fade-up" data-aos-duration="500">
                                <button className="pt-2 inline-flex items-center gap-x-4 w-full font-medium text-left text-gray-800 transition-all hover:text-gray-500 dark:text-gray-200 dark:hover:text-gray-400" data-fc-type="collapse">
                                    <div className="bg-blue-500/10 rounded-lg flex items-center justify-center h-12 w-12">
                                        <svg className="h-6 w-6 text-blue-500" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <button className="pt-2 inline-flex items-center gap-x-4 w-full font-medium text-left text-gray-800 transition hover:text-gray-500 dark:text-gray-200 dark:hover:text-gray-400" data-fc-type="collapse">
                                    <div className="bg-green-500/10 rounded-lg flex items-center justify-center h-12 w-12">
                                        <svg className="h-6 w-6 text-green-500" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                <polygon id="Shape" points="0 0 24 0 24 24 0 24"></polygon>
                                ...
                                <button className="pt-2 inline-flex items-center gap-x-4 w-full font-medium text-left text-gray-800 transition hover:text-gray-500 dark:text-gray-200 dark:hover:text-gray-400" data-fc-type="collapse">
                                    <div className="bg-orange-500/10 rounded-lg flex items-center justify-center h-12 w-12">
                                        <svg className="h-6 w-6 text-orange-500" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <div className="grid lg:grid-cols-2 grid-cols-1n gap-6 items-center">
                        <div className="order-2 lg:order-1 2xl:w-9/12" data-aos="fade-up" data-aos-duration="500">
                            ...
                            <div className="h-12 w-12 bg-primary/10 flex items-center justify-center rounded-lg">
                                <svg className="h-7 w-7 text-primary" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                        <rect id="bound" x="0" y="0" width="24" height="24"></rect>
        ...
        <div className="xl:py-24 py-16">
            <div className="container" data-aos="fade-up" data-aos-duration="600">
                    ...
                    <div className="grid xl:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-5">
                        <div className="order-1">
                            <div className="flex flex-col gap-5">
                                <p className="flex items-center gap-3"> <i className="fa-solid fa-check text-green-500 text-xl"></i> Hire and Retain Top Talent</p>
                                <p className="flex items-center gap-3"> <i className="fa-solid fa-check text-green-500 text-xl"></i> Team Management</p>
                            </div>
                        </div>

                        <div className="order-3 xl:order-2">
                            <div className="flex flex-col gap-5">
                                <p className="flex items-center gap-3"> <i className="fa-solid fa-check text-green-500 text-xl"></i> Stay Compliant</p>
                                <p className="flex items-center gap-3"> <i className="fa-solid fa-check text-green-500 text-xl"></i> Improve Productivity</p>
                                <p className="flex items-center gap-3"> <i className="fa-solid fa-check text-green-500 text-xl"></i> Improve Experience</p>
                            </div>
                        </div>

                        <div className="order-4 xl:order-3">
                            <div className="flex flex-col gap-5">
                                <p className="flex items-center gap-3"> <i className="fa-solid fa-check text-green-500 text-xl"></i> Self-service Time Tracking</p>
                                <p className="flex items-center gap-3"> <i className="fa-solid fa-check text-green-500 text-xl"></i> Performance Management</p>
                                <p className="flex items-center gap-3"> <i className="fa-solid fa-check text-green-500 text-xl"></i> Expert HR</p>
                            </div>
                        </div>

                        <div className="order-2 xl:order-4">
                            <div className="flex flex-col gap-5">
                                <p className="flex items-center gap-3"> <i className="fa-solid fa-check text-green-500 text-xl"></i> New Hire Checklist</p>
                                <p className="flex items-center gap-3"> <i className="fa-solid fa-check text-green-500 text-xl"></i> Tax Calculator</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <button className="flex items-center justify-center mx-auto">
                    <a href="#" className="bg-primary text-white rounded-lg text-sm font-semibold flex-none hover:shadow-lg  hover:shadow-primary/30 focus:shadow-none focus:outline focus:outline-primary/40 px-6 py-3">Get Your Photos Now <i className="fa-solid fa-arrow-right ms-2"></i> </a>
                </button>
    ...
    <section className="py-16 sm:py-24">
        <div className="container" data-aos="fade-up" data-aos-duration="2000">
            ...
            <div className="text-center">
                ...
                <p className="text-gray-500">Answers to common questions about our professional headshot service</p>
            </div>

            <div data-fc-type="accordion" className="mt-14 lg:w-3/4 lg:mx-auto 2xl:w-2/3">

                <div className="border border-gray-300 rounded-lg">
                    <button className="inline-flex p-5 items-center justify-between w-full font-semibold text-left transition" data-fc-type="collapse">
                ...
                <div className="border border-gray-300 rounded-lg mt-4">
                    <button className="p-5 inline-flex items-center justify-between w-full font-semibold text-left transition" data-fc-type="collapse">
            ...
            <div className="text-center mt-14">
                <p className="inline-flex flex-wrap gap-1 bg-gray-100 text-sm rounded-lg py-2 px-5">Still have unanswered questions?<a href="#" className="hover:text-primary transition-all"> Contact Us</a></p>
            </div>
