            ...
            <div className="order-2 lg:order-1">
                <div className="text-center sm:text-start">
                    ...
                    <h1 className="text-3xl/tight sm:text-4xl/tight lg:text-5xl/tight font-semibold mb-7">
                        The best way to
                        <span className="relative z-0 after:bg-green-500/50 after:-z-10 after:absolute md:after:h-6 after:h-4 after:w-full after:bottom-0 after:end-0">showcase</span> your saas
                    </h1>
                    <p className="sm:text-lg text-gray-500">Make your saas application stand out with high-quality landing page designed and developed by professional</p>
                    <div className="flex gap-4 mt-16">
                            <button className="flex items-center">
                                <a href="#" className="bg-primary text-white rounded-md hover:shadow-lg hover:shadow-primary/30 focus:shadow-none focus:outline focus:outline-primary/40 transition-all duration-500 py-2 px-4">Get Your Photos Now</a>
                            </button>
                            <button className="flex items-center">
                                <a href="#" className="border border-primary text-primary rounded-md hover:bg-primary hover:text-white hover:shadow-lg hover:shadow-primary/30 focus:shadow-none focus:outline focus:outline-primary/40 transition-all duration-500 py-2 px-4">How it Works</a>
                            </button>
                        </div>
                
                    <div className="flex flex-wrap items-center gap-5 mt-5">
                        <div className="flex items-center gap-2">
                            <svg className="stroke-green-500 stroke-2 w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
                    ...
                    <div id="swiper_one" className="swiper border-[6px] border-white bg-white 2xl:w-[140%]" data-aos="fade-left" data-aos-duration="1000">
                        <div className="swiper-wrapper">
                            <div className="swiper-slide">
                                ...
                                <img src="assets/images/hero/saas1.png" alt="saas1" className="w-full h-full rounded-md" />
                            </div>
                            ...
                            <div className="swiper-slide">
                                ...
                                <img src="assets/images/hero/saas2.png" alt="saas2" className="w-full h-full rounded-md" />
                            </div>
                            ...
                            <div className="swiper-slide">
                                ...
                                <img src="assets/images/hero/saas3.png" alt="saas3" className="w-full h-full rounded-md" />
                            </div>
                        </div>
                    </div>
...
<div className="absolute bottom-0 inset-x-0 hidden sm:block">
    <img src="assets/images/shapes/white-wave.svg" alt="white-wave-svg" className="w-full -scale-x-100 -scale-y-100" />
</div>
